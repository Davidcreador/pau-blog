        ...
        return (
            <Html>
                ...
                <body className="bg-gray-200 font-sans leading-normal tracking-normal">
                    <div className="w-full m-0 p-0 bg-cover bg-bottom" style={{ backgroundImage: `url(https://source.unsplash.com/collection/494263)`, height: "60vh", maxHeight: "460px" }}>
                        <div className="container max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
                            <p className="text-white font-extrabold text-3xl md:text-5xl">Paula de mamá</p>
                            <p className="text-xl md:text-2xl text-gray-500">Bienvenidos a mí Blog</p>
                        </div>
                    </div>
